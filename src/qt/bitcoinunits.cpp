...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("LUNA");
    case mBTC: return QString("mLUNA");
    case uBTC: return QString::fromUtf8("μLUNA");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("LUNAs"));
    case mBTC: return QString(QObject::tr("Milli-LUNAs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-LUNAs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
